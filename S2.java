...
import java.io.*;
class S2{
    String fib(String n,String[] f)
    {
        if(f[Integer.parseInt(n)]==null)
        {
            if(Integer.parseInt(n)<=1)
            {
                f[Integer.parseInt(n)]=n;
            }
            else{
                f[Integer.parseInt(n)]= digitadder(fib(digitsubtracter(n,"1"),f),fib(digitsubtracter(n,"2"),f));
            }
        }
