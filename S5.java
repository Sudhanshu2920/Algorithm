   ...
   String fib_matrix_Recursive(String n)
    {
        ...
        {
               String[][] M={{"1","1"},{"1","0"}};
               M=Power_recursive(M,digitsubtracter(n,"1"));
               return M[0][0];
        }
    }

   String[][] Power_recursive(String[][] M,String n)
   {
       ...
       if(Integer.parseInt(n)>1)
       {
           ...
           {
               c=Power_recursive(M,Integer.toString(a/2));
               M=Matrix_multiply(c,c);
           }
           else{
               c=Power_recursive(M,digitsubtracter(n,"1"));
    ...
    String[][] Matrix_multiply(String[][] a,String[][] b)
    {
        String[][] M=new String[2][2];
        M[0][0]=digitadder(multiply(a[0][0],b[0][0]),multiply(a[0][1],b[1][0]));
        M[0][1]=digitadder(multiply(a[0][0],b[0][1]),multiply(a[0][1],b[1][1]));
        M[1][0]=digitadder(multiply(a[1][0],b[0][0]),multiply(a[1][1],b[1][0]));
        M[1][1]=digitadder(multiply(a[1][0],b[0][1]),multiply(a[1][1],b[1][1]));
        return M;
    }
